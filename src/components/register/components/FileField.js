...
function FileField({ label, text, isRequired, subText = null, onInputChange }) {
  return (
    <div className="flex w-full flex-col py-4 px-2">
      ...
      <input
        ...
        className="form-control w-full px-3 py-2 text-gray-800 border rounded outline-none bg-gray-50"
      />
