    ...
    <motion.div initial={{ x: "300px", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-300px", opacity: 0 }}>
      <Breadcrumb
        crumbs={[
          ...
          { link: `/formbuilder/${formId}`, text: `${formId}` },
        ]}
      />
      <div className="flex justify-between mt-5">
        ...
        <div className="flex gap-x-2">
          <button
            ...
            className="h-10 md:h-15 inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-5 text-sm rounded-lg shadow outline-none gap-x-1 focus:outline-none focus:shadow-outline"
          >
